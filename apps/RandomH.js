...
export class RandomX extends plugin {
    ...
    constructor() {
        ...
        const configPath = _path + "/plugins/hl-plugin/config/RandomH.yaml"; // 配置文件路径
        ...
        this.imageDirPath = _path + '/plugins/miniheart-plugin/resources/hx'; // 图片文件夹路径
