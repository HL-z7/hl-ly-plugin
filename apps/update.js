...
export class update extends plugin {
  ...
  async runUpdate(isForce) {
    let command = "git -C ./plugins/hl-plugin/ pull --no-rebase";
    if (isForce) {
      command = `git -C ./plugins/hl-plugin/ checkout . && ${command}`;
    ...
    if (ret.error) {
      logger.mark(`${this.e.logFnc} 更新失败：hl插件`);
  ...
  async getLog(plugin = "") {
    ...
    let end = "";
      ...
      "更多详细信息，请前往gitee查看\nhttps://gitee.com/fox-glaze/hl-plugin/blob/master/README.md";
