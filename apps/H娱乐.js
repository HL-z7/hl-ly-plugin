...
export class CrazyThursdayPlugin extends plugin {
  ...
  async sendDirectVideo(e) {
    ...
    const videoUrls = {
      动漫: 'https://jx.iqfk.top/api/dmsp.php',
      萝莉: 'https://jx.iqfk.top/api/luoli.php',
      甜妹: 'https://v2.api-m.com/api/meinv?return=302',
      欲梦: 'https://jx.iqfk.top/api/ndym.php',
      黑丝: 'https://jx.iqfk.top/api/heisis.php',
      白丝: 'https://jx.iqfk.top/api/baisis.php'
    };
