...
export class tags extends plugin {
    ...
    async magic(e) {
        const tags = [
            ...
            'sleeveless dress', 'robe', 'black silk stocking', 'JK', 'business_suit', 'slit pupils', 'stare', 'animal_ears',
