...
export class RandomMP3 extends plugin {
    constructor() {
        ...
        // 读取配置文件
        const configPath = path.join(__dirname, 'plugins/hl-ly-plugin/config/shuo.yaml'); // 配置文件路径
        ...
        // 设置MP3文件夹路径
        this.mp3DirPath = path.join(__dirname, 'plugins/hl-ly-plugin/resources/shuoMP3');//放MP3的文件夹
    }
