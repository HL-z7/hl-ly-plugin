...
- 如已安装请立即卸载！
## 部分功能已经适配Miao-Yunzai
- 但不完全适配，使用TRSS-Yunzai体验最佳
- HL插件是按照TRSS-Yunzai写的，所以推荐用TRSS崽安装本插件，由于没有多余的资源去测试Miao-Yunzai是否适配且不会报错，所以如有报错请卸载 谢谢！


## 声明
- 如果觉得插件不好用或者功能多余且无用请立即删除 谢谢！不要整什么有的没的
- 如果感觉插件写的烂  那确实 我没有您那么强的能力去写更厉害的功能，只能去玩别人剩下的，真觉得不好用那请如此有实力的您自己写一个比HL插件更厉害的插件 我是fw写不来
...
| 帮助 | #hl帮助 | 发送本插件帮助图 |
| 天气 | H天气广东 | 天气预报 |
| 多样式戳一戳 | 发送 #HL设置 查看配置 | 多样化 |
| 翻译 | #h翻+要翻译的内容 | 翻译文本 |
| 疯狂星期四 | #随机kfc | 发送KFC文案 |
| gif转长图 | 转长图 | 将gif图片转长图 |
| 语音 | H说话 | 发送赛马娘音频 |
| 今日运势 | #运势 | 查看今日运势 |
| 表情包/cos | hl列表 | 发送即可查看具体功能 |
| 快捷群管 | #hl帮助 | 查看帮助图查看具体功能 |
| 违禁词禁言 | H违禁词帮助 | 查看更详细功能用法 |
| 快捷下载 | 取文件+路径目标文件/取包+路径目标文件夹 | 快捷下载崽的文件/文件夹 |
| 快捷下载（附加） | 开启/关闭私发 | 开启后文件只会发送至主人私信 关闭则发送至触发指令的群聊 |
| 一键群发 | 一键群发+内容（具体功能发送【H群发帮助】查看） | 支持TRSS多账号指定bot号发送 |
| 各种加密 |  |  |
| url加密/解密 | Hurl加密/解密+内容 | 加密/解密 |
| base64加密/解密 | Hbase64加密/解密+内容 | 加密/解密 |
| base64加密/解密 | Hb64加密/解密+内容 | 加密/解密Hex 16进制 不编码 |
| MD5加密 | Hmd5加密+内容 | 加密 |
| Unicode加密/解密 | HUnicode加密/解密+内容 | 加密/解密 |
