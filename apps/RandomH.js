...
export class RandomX extends plugin {
    constructor() {
        ...
        // 读取配置文件
        const configPath = path.join(__dirname, 'plugins/hl-plugin/config/RandomH.yaml'); // 配置文件路径
        ...
        // 设置图片文件夹路径
        this.imageDirPath = path.join(__dirname, 'plugins/hl-plugin/resources/hx'); // 图片文件夹路径
    }
